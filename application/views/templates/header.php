...
<head>
  ...
  <title><?php echo isset($title) && $title != '' ? $title : 'SEO Portal'; ?></title>
  <!-- Bootstrap core CSS-->
  ...
  <link href="<?php echo assets_url(); ?>vendor/datatables/dataTables.bootstrap4.css" rel="stylesheet">
...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    <a class="navbar-brand" href="index.html">SEO Portal</a>
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Users">
          <a class="nav-link" href="<?php echo base_url('users/all'); ?>">
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Manage Services">
          ...
          <ul class="sidenav-second-level collapse" id="collapseComponents">
            <li>
              <a href="<?php echo base_url('services/viewall'); ?>">Services</a>
            </li>
            <li>
